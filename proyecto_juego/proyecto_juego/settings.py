"""
Django settings for proyecto_juego project.
...
SECRET_KEY = 'a^hzi1acgji#39e2+4%l7(bmjqu$bt(=o!@fi^3e#xt-o=lt(r'
...
ROOT_URLCONF = 'proyecto_juego.urls'

WSGI_APPLICATION = 'proyecto_juego.wsgi.application'
